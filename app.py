...
# Check for keys in Streamlit Secrets (for Cloud Deployment)
...
def ensure_vector_store():
    if not os.path.exists(PERSIST_DIRECTORY):
        with st.spinner("Downloading and processing data... This may take 5-10 minutes on the first run."):
...
st.sidebar.markdown("---")
st.sidebar.caption("© 2026 Faraz Sharique Ali. All Rights Reserved.")
st.sidebar.caption("Built by [Faraz Sharique Ali](https://www.linkedin.com/in/alifraz/) | Data: [teyler/epstein-files-20k](https://huggingface.co/datasets/teyler/epstein-files-20k)")
st.sidebar.caption("Disclaimer: I assume no responsibility for any incorrect or false information provided by the application. Answers are generated by AI. Use it at your own discretion.")
