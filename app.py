...
st.markdown("---")
st.caption("Built by [Faraz Sharique Ali](https://www.linkedin.com/in/alifraz/) | Data: [teyler/epstein-files-20k](https://huggingface.co/datasets/teyler/epstein-files-20k)")
st.caption("Disclaimer: I assume no responsibility for any incorrect or false information provided by the application. Answers are generated by AI. Use it at your own discretion.")
